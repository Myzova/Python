...
def read_records():
    """Считывание данных из телефонного справочника"""
...
def show_all():
    """Отображение содержимого телефонного справочника"""
...
def change_contact(data_tuple):
    """Изменение существующей записи в телефонном справочнике"""
...
def exist_contact(rec_id, data):
    """Проверка записи в телефонном справочнике
